% Newton iteration method do the damped inverse Gauss-Newton with Levenberg-Marquadt  用Levenberg-Marquardt做阻尼逆高斯-牛顿
% Code editor: LuoZu
% Time: 2019-11-25
function qt = ikine_NL(robot, tr, varargin)
    ...
    for i=1:length(TT) %1：1
        ...
        while true
            ...
            if ~isnan(opt.transpose)
                ...
                % Levenberg-Marquadt  用Levenberg-Marquardt做阻尼逆高斯-牛顿
