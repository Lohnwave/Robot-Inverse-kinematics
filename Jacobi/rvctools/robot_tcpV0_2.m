...
% * Version: 2.0																*
% * Last Revised: 2019-06-25													*
% * Eritor: Luozu																*
% * v 1.0: 计算Leap motion 采集的手平移、姿态逆运动学，并通过以太网传给机械臂		 *
% * v 2.0: 增加手指位置采集                                                      *
% \******************************************************************************/
clear;
clc;
...
%             fprintf('getMessage: %f, %f, %f, %f, %f, %f, %f, %f\n success \n',...
...
%             z=z0+point(3)*1.5;
            ...
            fingerDistance01 = point(7);
            fingerDistance02 = point(8);
...
%             robot.plot(J);
            ...
            J6=num2str(J(6));
            J7=num2str(J(7));
            FingerDistance01Str = num2str(fingerDistance01);
            FingerDistance02Str = num2str(fingerDistance02);
            ...
            if ((counter ~= 1)&& (sum(abs(J(1:4)-theta(1:4)))>L_Transl||sum(abs(J(5:7)-theta(5:7)))>L_Posture))
               ...
               message=[J1,',',J2,',',J3,',',J4,',',J5,',',J6,',',J7,',',FingerDistance01Str,',',FingerDistance02Str];
               fopen(tcpipUDP);
               fprintf(tcpipUDP,message);
               fprintf('sendMessage: %f, %f, %f, %f, %f, %f ,%f, %f\n',J(1), J(2), J(3),J(4), J(5), J(6), fingerDistance01, fingerDistance02);
